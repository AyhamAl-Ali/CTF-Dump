...
![1.png](./assets/1.png)
> Link: http://44.200.237.73/

### Solution
- It's a nice PHP code to bypass
- ![2.png](./assets/2.png)
```php
<?php  
session_start();  
...
?>
```
- My first impression was, we will probably use **PHP Wrappers**
- After some searching `RCE from LFI` I found this [link](https://book.hacktricks.xyz/pentesting-web/file-inclusion/lfi2rce-via-php-filters) on HackTricks
- Here I was pretty sure this is how I will exploit it
...
- I  got this result
- ![4.png](./assets/4.png)
- Then I used `ls /` and got this result
- ![5.png](./assets/5.png)
- Aaaaaand here we GOOO!!
- ![6.png](./assets/6.png)
